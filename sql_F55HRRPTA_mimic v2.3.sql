SELECT
  ...
  case when
  wcm.IWPILC IN ('M', 'C') OR
      WLMCU IN ('53001C', '52005C', '52004C', '52003C', '53002C','58089')
	  then 'M' else 'L' end 
...
LEFT OUTER JOIN dbo.F30006_WorkCenterMaster AS wcm
  ON LTRIM(RTRIM(wcm.IWMMCU)) = x.WLMMCU
  AND LTRIM(RTRIM(wcm.IWMCU)) = x.WLMCU